<?php
/**
 * Step 3: Product Design — Alpha Tackle / Bravo Tackle
 *
 * Same as Charlie Tackle but:
 * - Colors: White, Lead, Charcoal, Black, Purple
 * - No "Custom Design" on shoulder or pants config
 * - Nameplate pricing shown ($6.25/uniform)
 * - Tackle Twill upgrade option ($4.50/uniform)
 *
...
$colors = $standard_colors ?? ['White', 'Lead', 'Charcoal', 'Black', 'Purple'];
?>
    ...
    <div class="bsp-intake__fields">
        <fieldset class="bsp-intake__fieldset">
            ...
            <div class="bsp-intake__field">
                ...
                <p class="bsp-intake__pricing"><?php esc_html_e('$6.25/uniform', 'battle-sports-platform'); ?></p>
                <div class="bsp-intake__radios" role="radiogroup">
            ...
            <div class="bsp-intake__field">
                <span class="bsp-intake__label"><?php esc_html_e('Tackle Twill upgrade', 'battle-sports-platform'); ?> <span class="bsp-intake__required">*</span></span>
                <p class="bsp-intake__pricing"><?php esc_html_e('$4.50/uniform', 'battle-sports-platform'); ?></p>
                <div class="bsp-intake__radios" role="radiogroup">
                    <label class="bsp-intake__radio-label"><input type="radio" name="bsp_design_tackle_twill" value="No - keep silk screen" class="bsp-intake__radio" data-validate="required"> <?php esc_html_e('No - keep silk screen', 'battle-sports-platform'); ?></label>
                    <label class="bsp-intake__radio-label"><input type="radio" name="bsp_design_tackle_twill" value="Yes - upgrade ($4.50/uniform)" class="bsp-intake__radio"> <?php esc_html_e('Yes - upgrade ($4.50/uniform)', 'battle-sports-platform'); ?></label>
                </div>
                <span class="bsp-intake__error"></span>
            </div>
        </fieldset>
