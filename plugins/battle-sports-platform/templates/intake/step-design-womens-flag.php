<?php
/**
 * Step 3: Product Design — Women's Flag
 *
 * Same structure as 7v7 but with women's-specific jersey styles and bottom garment options.
 *
    ...
    <div class="bsp-intake__fields">
        <fieldset class="bsp-intake__fieldset">
            ...
            <div class="bsp-intake__field">
                ...
                <div class="bsp-intake__radios" role="radiogroup">
                    <label class="bsp-intake__radio-label"><input type="radio" name="bsp_design_jersey_style" value="V-Neck Sleeveless" class="bsp-intake__radio" data-validate="required"> <?php esc_html_e('V-Neck Sleeveless', 'battle-sports-platform'); ?></label>
                    <label class="bsp-intake__radio-label"><input type="radio" name="bsp_design_jersey_style" value="V-Neck Short Sleeve" class="bsp-intake__radio"> <?php esc_html_e('V-Neck Short Sleeve', 'battle-sports-platform'); ?></label>
                    <label class="bsp-intake__radio-label"><input type="radio" name="bsp_design_jersey_style" value="Long Sleeve Compression" class="bsp-intake__radio"> <?php esc_html_e('Long Sleeve Compression', 'battle-sports-platform'); ?></label>
                    <label class="bsp-intake__radio-label"><input type="radio" name="bsp_design_jersey_style" value="Racer Back Compression" class="bsp-intake__radio"> <?php esc_html_e('Racer Back Compression', 'battle-sports-platform'); ?></label>
                </div>
                <span class="bsp-intake__error"></span>
            </div>
        ...
        <fieldset class="bsp-intake__fieldset">
            <legend class="bsp-intake__legend"><?php esc_html_e('Bottom Garment', 'battle-sports-platform'); ?></legend>

            <div class="bsp-intake__field">
                <span class="bsp-intake__label"><?php esc_html_e('Bottom garment', 'battle-sports-platform'); ?> <span class="bsp-intake__required">*</span></span>
                <div class="bsp-intake__radios" role="radiogroup">
                    <label class="bsp-intake__radio-label"><input type="radio" name="bsp_design_bottom_garment" value="Standard Shorts" class="bsp-intake__radio" data-validate="required"> <?php esc_html_e('Standard Shorts', 'battle-sports-platform'); ?></label>
                    <label class="bsp-intake__radio-label"><input type="radio" name="bsp_design_bottom_garment" value="Compression Shorts" class="bsp-intake__radio"> <?php esc_html_e('Compression Shorts', 'battle-sports-platform'); ?></label>
                    <label class="bsp-intake__radio-label"><input type="radio" name="bsp_design_bottom_garment" value="Compression Leggings" class="bsp-intake__radio"> <?php esc_html_e('Compression Leggings', 'battle-sports-platform'); ?></label>
                </div>
                <span class="bsp-intake__error"></span>
            </div>
